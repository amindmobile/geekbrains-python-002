...
# вернет строку: **\n\n. Или, количество ячеек клетки равняется 15, количество ячеек в ряду — 5. Тогда метод make_
# order() вернет строку: **\n\n***. Подсказка: подробный список операторов для перегрузки доступен в гугле.
...
class Cell:
    ...
    def __add__(self, other):
        return f'\nКлеточные обнимашки: {str(self.nums + other.nums)}'

    def __sub__(self, other):
        return f'\nСдохло клеток: {str(self.nums - other.nums)}'

    def __mul__(self, other):
        return f'\nБыстрое размножение клеток: {str(self.nums * other.nums)}'

    def __truediv__(self, other):
        return f'\nДеление: {round(self.nums / other.nums)}'


#  эту кашу надо научиться сокращать
cell_01 = Cell(140)
cell_02 = Cell(33)
print(cell_01 + cell_02)
print(cell_02.make_order(9))
print(cell_01 * cell_02)
print(cell_02.make_order(10))
print(cell_01 / cell_02)
print(cell_02.make_order(11))
print(cell_01 - cell_02)
print(cell_02.make_order(12))
